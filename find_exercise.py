...
def take_int_list_input(category_list, catergory_id_list, query_word):
    ...
    while break_category_loop==False:
        ...
        user_category_input = input("Choose " + query_word + " number from the above list. Put COMMA(,) for multiple selection. \nYou can press ENTER to skip: ")
...
if __name__ == '__main__':
    ...
    try:
        output_exercise_list=output_exercise_list[0:max_output_number]
    except:
        print()
